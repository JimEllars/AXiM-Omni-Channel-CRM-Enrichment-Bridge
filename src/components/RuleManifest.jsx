...
import { FiInfo, FiCode, FiToggleLeft, FiToggleRight } from 'react-icons/fi';

export default function RuleManifest({ activeRules, onRulesChange }) {
  const toggleRule = (id) => {
      ...
      <div className="p-8">
        ...
        <div className="mt-8 p-5 bg-blue-500/5 rounded-2xl border border-blue-500/10 flex gap-4 items-start">
          ...
          <p className="text-xs text-blue-300/70 leading-relaxed">
            Rule modifications are persisted to <strong className="text-blue-400">Google Sheets</strong>. 
            Toggling a rule here will impact the sandbox engine and telemetry validation logic globally.
          </p>
        </div>
      </div>
    </div>
